<div align="center">
  ...
  🌎 <a href="./docs/portuguese/README-pt.md">Versão em Português</a><br>
    🧭 <a href="./docs/english//architecture.jpe">View Automation Architecture</a><br>
</div>
...
The following variables must be defined to run the tests, which are saved in './src/resources/config/test-config.yml'.
